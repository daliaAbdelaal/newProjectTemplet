...
@Component({
    selector: 'app-mshp-newsletter',
    templateUrl: './mshp-newsletter.component.html',
    styleUrls: ['./mshp-newsletter.component.scss']
})
export class MshpNewsletterComponent implements OnInit {
