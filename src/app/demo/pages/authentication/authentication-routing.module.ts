...
const routes: Routes = [
    {
        ...
        children: [
            ...
            },
            {
                path: 'reset-password',
                loadChildren: () =>
                    import('./auth-reset-password/auth-reset-password.module').then((module) => module.AuthResetPasswordModule)
            },
            {
                path: 'reset-password-v2',
                loadChildren: () =>
                    import('./auth-reset-password-v2/auth-reset-password-v2.module').then((module) => module.AuthResetPasswordV2Module)
            },
            {
                path: 'change-password',
                loadChildren: () =>
                    import('./auth-change-password/auth-change-password.module').then((module) => module.AuthChangePasswordModule)
            },
            {
                path: 'change-password-v2',
                loadChildren: () =>
                    import('./auth-change-password-v2/auth-change-password-v2.module').then((module) => module.AuthChangePasswordV2Module)
            },
            {
            ...
            },
            {
                ...
                loadChildren: () =>
                    import('./auth-profile-settings/auth-profile-settings.module').then((module) => module.AuthProfileSettingsModule)
            }
        ]
    }
];
