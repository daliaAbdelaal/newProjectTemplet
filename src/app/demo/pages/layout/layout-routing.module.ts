...
const routes: Routes = [
    {
        ...
        children: [
            ...
            },
            {
                path: 'collapse-menu',
                loadChildren: () =>
                    import('./theme-collapse-menu/theme-collapse-menu.module').then((module) => module.ThemeCollapseMenuModule)
            },
            {
                path: 'vertical-rtl',
            ...
            },
            {
                path: 'horizontal-l2',
                loadChildren: () =>
                    import('./theme-horizontal-l2/theme-horizontal-l2.module').then((module) => module.ThemeHorizontalL2Module)
            },
            {
                path: 'horizontal-rtl',
