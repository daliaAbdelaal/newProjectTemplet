...
const routes: Routes = [
    {
        ...
        children: [
            ...
            },
            {
                path: 'tbl-datatable',
                loadChildren: () =>
                    import('./demo/pages/tables/tbl-datatable/tbl-datatable.module').then((module) => module.TblDatatableModule)
            },
            {
                path: 'charts',
            ...
            },
            {
                path: 'full-calendar',
                loadChildren: () =>
                    import('./demo/extension/full-event-calendar/full-event-calendar.module').then(
                        (module) => module.FullEventCalendarModule
                    )
            },
            {
                path: 'file-upload',
